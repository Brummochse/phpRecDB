 ...
 *
 * The followings are the available columns in table 'radiobutton':
 * @property string $id
 * @property string $users_id
 * @property string $element_id
 * @property string $value
 */
class Radiobutton extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Radiobutton the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('element_id, value', 'length', 'max'=>255),
