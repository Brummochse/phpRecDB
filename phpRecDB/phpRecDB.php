...
require_once(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'app' . DIRECTORY_SEPARATOR . 'common' . DIRECTORY_SEPARATOR . 'libs' . DIRECTORY_SEPARATOR . 'yii-1.1.19' . DIRECTORY_SEPARATOR . 'yii.php');
