<div class="form">
    ...
    <div id="all">
        <div id="left" class="column">
            ...
            echo $form->dropDownListGroup($model, 'rectypes_id', array ('widgetOptions'=>array ('data'=>CHtml::listData(Rectype::model()->findAllByAttributes(array('bootlegtypes_id' => $vaId)), 'id', 'label'), Helper::$dropBoxDefaultNullStr)));
            echo $form->dropDownListGroup($model, 'sources_id', array ('widgetOptions'=>array ('data'=>CHtml::listData(Source::model()->findAllByAttributes(array('bootlegtypes_id' => $vaId)), 'id', 'label'), Helper::$dropBoxDefaultNullStr)));
            echo $form->textFieldGroup($model, 'sumlength', array( 'widgetOptions'=>array ('htmlOptions'=>array('maxlength' => 10))));
            echo $form->dropDownListGroup($model, 'media_id', array ('widgetOptions'=>array ('data'=>CHtml::listData(Medium::model()->findAllByAttributes(array('bootlegtypes_id' => $vaId)), 'id', 'label'), Helper::$dropBoxDefaultNullStr)));
            echo $form->textFieldGroup($model, 'summedia', array( 'widgetOptions'=>array ('htmlOptions'=>array('maxlength' => 10))));
            echo $form->dropDownListGroup($model, 'quality', array ('widgetOptions'=>array ('data'=>Helper::generateCountedArray(0, 10), Helper::$dropBoxDefaultNullStr)));
            echo $form->dropDownListGroup($model, 'tradestatus_id', array ('widgetOptions'=>array ('data'=>CHtml::listData(Tradestatus::model()->findAll(), 'id', 'label'), Helper::$dropBoxDefaultNullStr)));
