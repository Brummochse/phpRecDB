...
/**
 * This is the model class for table "rectypes".
 *
 * The followings are the available columns in table 'rectypes':
 * @property integer $id
 ...
 */
class Rectype extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return Rectype the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'recordings' => array(self::HAS_MANY, 'Recordings', 'rectypes_id'),
		);
	}
