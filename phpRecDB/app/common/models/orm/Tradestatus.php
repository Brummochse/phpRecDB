...
/**
 * This is the model class for table "tradestatus".
 *
 * The followings are the available columns in table 'tradestatus':
 * @property string $id
...
class Tradestatus extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('label, shortname', 'required'),
			array('label, shortname', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, label, shortname', 'safe', 'on'=>'search'),
		);
	}
