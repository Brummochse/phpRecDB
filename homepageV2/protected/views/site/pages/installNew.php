...
<p><h2>step 4.</h2> open the file <?php echo TbHtml::code('dbConfig.php'); ?> with a texteditor (for example notepad). <br>
You can find this file in the folder <?php echo TbHtml::code('phpRecDB/settings/'); ?>. <br>
...
<p><h2>step 6.</h2> there is write-permission required for this 3 folders on your webspace server:<br>
<ul>
    <li><?php echo TbHtml::code('phpRecDB/assets'); ?></li>
    <li><?php echo TbHtml::code('phpRecDB/screenshots'); ?></li>
    <li><?php echo TbHtml::code('phpRecDB/misc'); ?></li>
</ul>
ensure that all of this folders are writeable.<br>
(Here is a guide how to set write permission with the ftp client FileZilla <a href="http://www.dummies.com/how-to/content/how-to-change-file-permissions-using-filezilla-on-.html">link</a>.)


<p><h2>step 7.</h2> open the demo site and switch to the adminstration panal, log in and change the default user password.<br/></p>
