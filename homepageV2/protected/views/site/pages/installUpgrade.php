...
<p><h2>step 4.</h2>go to your current installation folder and delete all folders and files in the dirctory <?php echo TbHtml::code('phpRecDB'); ?><b>except</b> this folders:<br>
<ul><li><?php echo TbHtml::code('phpRecDB/settings'); ?></li><li><?php echo TbHtml::code('phpRecDB/screenshots'); ?></li></ul>
</p>

<p><h2>step 5.</h2>copy all other folders and files from the new version into your <?php echo TbHtml::code('phpRecDB'); ?> folder (do NOT overwrite the 2 folders <?php echo TbHtml::code('settings'); ?> and <?php echo TbHtml::code('screenshots'); ?></p>
