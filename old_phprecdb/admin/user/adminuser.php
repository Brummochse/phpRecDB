...
class ContentPage extends ContentPageEcho {
    ...
    public function execute($smarty,$linky) {
        include Constants::getLibsFolder()."SimpleMember/adminpro_config.php";
        include Constants::getLibsFolder()."SimpleMember/adminuser_config.php";
        ...
        if ($prot2->showPage) {
            ...
            $db->connect($dbInfo->getHost(), $dbInfo->getUser(), $dbInfo->getPass(), $dbInfo->getDb());
            ...
            if ($adminConfig['htmlCss'] != "") {
                echo "<link rel=\"stylesheet\" type=\"text/css\" href=\"" . getRelativePathTo(Constants::getAdminFolder()."user/").$adminConfig['htmlCss'] . "\">";
            }
            ?>
<div id="adminuser">
    <hr></hr>
    ...
    <div align="center">
		...
		**  thanks to robert 
                        */
                        ...
                        $out .= "<option value=\"1\"";
                        if ($data['userGroup'] == "1" || !$data['userGroup']) {
                            $out .= " selected=\"selected\"";
                        }
                        $out .= ">1";
