...
$dbInfo=new DbConfig();
$globalConfig['dbhost']=$dbInfo->getHost(); // Your MySQL Server Host URL
$globalConfig['dbuser']=$dbInfo->getUser(); // Your MySQL Username
$globalConfig['dbpass']=$dbInfo->getPass(); // Your MySQL Password
$globalConfig['dbase']=$dbInfo->getDb(); // Your MySQL Database name
...
include_once dirname(__FILE__) . '/../../functions/function.getRelativePathTo.php';


$relPath=getRelativePathTo(dirname(__FILE__));

$login=$relPath."../../index.php";
$logout=$relPath."logout.php";


$globalConfig['loginUrl']=$login; // The URL of the login page
$globalConfig['logoutUrl']=$logout; // The URL of the logout page
/*
